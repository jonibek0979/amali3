...
let elSection__wrapper = document.querySelector('.section__wrapper')

function openModl() {
    elSection__wrapper.classList.add('section__wrapper__modal')

}
function closeModl() {
    elSection__wrapper.classList.remove('section__wrapper__modal')
